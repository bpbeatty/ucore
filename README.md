...
```bash
sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/bpbeatty/ucore-hci:stable
```
...
```bash
sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/bpbeatty/ucore-hci:testing
```
